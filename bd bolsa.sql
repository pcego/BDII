...
create index IX_Acoes_Tipo on acoes(tipo);
create index IX_Acoes_Nome on acoes(nome);
...
create index IX_acoesxusuarios_data on acoesxusuarios(data);
...
create view precomedio as
  ...
  from transacoes as t 
    join acoes as a on t.acao = a.codigo
  where t.tipo = 1
